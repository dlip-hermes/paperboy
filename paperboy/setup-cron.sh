...
echo "   8:54 AM — paperboy-briefing (radio briefing + TTS audio, via context_from)"
echo ""
echo "🚀 Next run: Tomorrow at 7:00 AM (paperboy) + 8:54 AM (paperboy-briefing)"